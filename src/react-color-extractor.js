//This file is from "React Color Extractor", an extension that I used to build this app. It worked easier being called from here.
...
var ColorExtractor = (function (_React$Component) {
			...
			(_ret =
				...
				(_this.processImage = function () {
					if (_this.props.children) {
						...
						_this.props.src &&
						typeof _this.props.src === "string" &&
						_this.props.src.length > 0
					) {
				...
				(_this.parseImage = function (image, props) {
					Vibrant.from(image)
						...
						.then(function (swatches) {
							return props.getColors(
								_this.getColorsFromSwatches(swatches, props)
							);
						})
	...
	ColorExtractor.prototype.componentDidUpdate = function componentDidUpdate(
		props
	) {
